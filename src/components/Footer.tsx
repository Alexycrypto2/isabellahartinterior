          ...
          <div className="grid md:grid-cols-4 gap-12">
            ...
            <div className="md:col-span-1">
              <Link to="/" className="flex items-center gap-2 mb-4">
                ...
                <div className="relative w-8 h-8 flex items-center justify-center">
                  ...
                  <span className="relative text-accent-foreground font-display text-base font-bold">G</span>
                </div>
                <span className="font-display text-xl font-semibold">
                  <span className="text-accent">Glam</span><span className="text-foreground">ify</span>
                </span>
              </Link>
              <p className="text-muted-foreground text-sm mb-6">
                Curating sophisticated fashion for the modern woman. Timeless elegance meets contemporary style.
              </p>
            ...
            <div>
              ...
              <ul className="space-y-3">
                ...
                <li>
                  <Link to="/categories?filter=clothing" className="text-muted-foreground hover:text-accent transition-colors text-sm">
                    Clothing
                  </Link>
                </li>
                <li>
                  <Link to="/categories?filter=accessories" className="text-muted-foreground hover:text-accent transition-colors text-sm">
                    Accessories
                  </Link>
                </li>
                <li>
                  <Link to="/categories?filter=jewelry" className="text-muted-foreground hover:text-accent transition-colors text-sm">
                    Jewelry
                  </Link>
                </li>
              </ul>
            ...
            {/* Resources */}
            <div>
              <h4 className="font-display text-lg font-medium mb-4">Style</h4>
              <ul className="space-y-3">
                <li>
                ...
                <li>
                  <Link to="/blog/capsule-wardrobe-essentials" className="text-muted-foreground hover:text-accent transition-colors text-sm">
                    Capsule Wardrobe
                  </Link>
                </li>
                <li>
                  <Link to="/blog/accessory-styling-guide" className="text-muted-foreground hover:text-accent transition-colors text-sm">
                    Accessory Guide
                  </Link>
                </li>
              </ul>
          ...
          <div className="border-t border-border mt-12 pt-8">
            <div className="flex flex-col md:flex-row items-center justify-between gap-4">
              <p className="text-muted-foreground text-sm">
                © {new Date().getFullYear()} Glamify. All rights reserved.
              </p>
